...
public class CsvResultSet implements ResultSet {
	 ...
	 * @param whereValue
	 *            The string to be sought for
	 * @param columnTypes
	 *            A comma-separated string specifying the type of the i-th
	 *            column of the database table (not of the result).
	 * @param whereColumnName
	 *            the name of the column, needed late by a select *
	 * @throws ClassNotFoundException
	 *             in case the typed columns fail
	 * @throws SQLException
	 */
	protected CsvResultSet(CsvStatement statement, DataReader reader, String tableName, List queryEnvironment, int isScrollable, ExpressionParser whereClause, String columnTypes, int skipLeadingLines)
		...
		if (reader instanceof CsvReader) {
			// timestampFormat =
			// ((CsvConnection)statement.getConnection()).getTimestampFormat();
	 ...
	 * 
	 * @param columnName
	 *            the SQL name (or alias) of the column
	 * @return the column value; if the value is SQL <code>NULL</code>, the
	 *         value returned is <code>null</code>
	 * @exception SQLException
	 *                if a database access error occurs
	 ...
	 * types.
	 * 
	 * In the JDBC 2.0 API, the behaviour of method <code>getObject</code> is
	 * extended to materialize data of SQL user-defined types. When a column
	 * contains a structured or distinct value, the behaviour of this method is
	...
	public BigDecimal getBigDecimal(int columnIndex) throws SQLException {
		...
		if (str != null) {
			try {
				...
				throw new SQLException("Could not convert '" + str + "' to " + "a java.math.BigDecimal object");
			}
		}
		return retval;
	}
	...
	public void updateCharacterStream(int columnIndex, Reader x, int length) throws SQLException {
		throw new UnsupportedOperationException("ResultSet.updateCharacterStr" + "eam(int, Reader, int) unsupported");
	}
	...
	public void updateCharacterStream(String columnName, Reader reader, int length) throws SQLException {
		throw new UnsupportedOperationException("ResultSet.updateCharacterStr" + "eam(String, Reader, int) unsupported");
	}
