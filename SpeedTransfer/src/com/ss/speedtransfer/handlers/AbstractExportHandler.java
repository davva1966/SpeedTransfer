...
public abstract class AbstractExportHandler extends AbstractHandler {
	...
	protected static AbstractExportHandler lastUsedHandler = null;
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (selectedItem instanceof IFile) {
				export((IFile) selectedItem);
				if (isProperHandler())
					lastUsedHandler = this;
			}
	...
	protected abstract void export(IFile queryFile);
