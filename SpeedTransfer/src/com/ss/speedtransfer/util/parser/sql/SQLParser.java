...
/**
 * The class <code>SQLParser</code> takes a filename as input and parses the source file than can be a sql file
 * <p>
 * The result is a parse tree starting with the top node <code>StatementTree</code>
 */
public class SQLParser implements SQLParserConstants {
	...
	/**
	 * Creates and returns a parameter substitution. This is called when the parser comes across a '?' style object. This object is used to mark an expression with a place mark that can be substituted
	 * for a value later.
	 */
	...
	/**
	 * Parse the sql passed
	 * 
	 * @param data
	 *            - the sql to parse
	 */
	public static StatementTree parse(String data) {
		...
		try {
			...
			try {
				...
				// IBSEnvironmentLog.getLogger().error("SQLParser parsing error: "+data+" cause:" + e,e);
			}

			stream.Done();
			return tree;
		} catch (Exception e) {
			// IBSEnvironmentLog.getLogger().error("SQLParser: " + e,e);
			return null;
		}
	}
	...
	// Added for AS400 embedded SQL
	final public StatementTree Execute() throws ParseException {
		StatementTree cmd = new StatementTree("Execute");
		Token t1 = null;
		Token t2 = null;
		...
		if (t1 != null)
			cmd.putObject("variable", t1.image.substring(1));
		if (t2 != null)
			cmd.putObject("statement", t2.image.substring(1));
		{
			if (true)
				return cmd;
		}
	...
	// Added for AS400 embedded SQL
	final public StatementTree Prepare() throws ParseException {
		StatementTree cmd = new StatementTree("Prepare");
		Token t1;
		Token t2 = null;
		...
		cmd.putObject("statement", t1.image);
		cmd.putObject("variable", t2.image.substring(1));
		{
			if (true)
				return cmd;
		}
	...
	// Added for AS400 embedded SQL
	final public StatementTree Declare() throws ParseException {
		StatementTree cmd = new StatementTree("Declare");
		Token t1;
		Token t2 = null;
		StatementTree t3 = null;
		...
		cmd.putObject("cursor", t1.image);
		if (t2 != null)
			cmd.putObject("statement", t2.image);
		else
			cmd.putObject("select", t3);
	...
	// Added for AS400 embedded SQL
	final public StatementTree Open() throws ParseException {
		StatementTree cmd = new StatementTree("Open");
		Token t1;
	...
	// Added for AS400 embedded SQL
	final public StatementTree Close() throws ParseException {
		StatementTree cmd = new StatementTree("Close");
		Token t1;
	...
	// Added for AS400 embedded SQL
	final public StatementTree Fetch() throws ParseException {
		StatementTree cmd = new StatementTree("Fetch");
		Token t1 = null;
		Token t2 = null;
		Token t3 = null;
		...
		if (t1 != null)
			cmd.putObject("mode", t1.image);
		cmd.putObject("cursor", t2.image);
		cmd.putObject("variables", list);
		{
			if (true)
				return cmd;
		}
	...
	// Added for AS400 embedded SQL
	final public StatementTree Whenever() throws ParseException {
		StatementTree cmd = new StatementTree("Whenever");
		Token t1 = null;
		Token t2 = null;
		...
		t1 = jj_consume_token(IDENTIFIER);
		cmd.putObject("label", t1.image);
		cmd.putObject("type", t2.image);
		{
			if (true)
				return cmd;
		}
	...
	final public StatementTree Select() throws ParseException {
		StatementTree cmd = new StatementTree("Select");
		...
		case FOR_FETCH_ONLY:
			switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
			case WITH_NC:
				jj_consume_token(WITH_NC);
				break;
			case FOR_FETCH_ONLY:
				jj_consume_token(FOR_FETCH_ONLY);
				break;
			default:
				jj_la1[17] = jj_gen;
				jj_consume_token(-1);
	...
	final public StatementTree Update() throws ParseException {
		StatementTree cmd = new StatementTree("UpdateTable");
		String table_name;
	...
	final public StatementTree AlterTable() throws ParseException {
		StatementTree cmd = new StatementTree("AlterTable");
		String table_name;
	...
	final public StatementTree Compact() throws ParseException {
		StatementTree cmd = new StatementTree("Compact");
		String table_name;
	...
	final public StatementTree CreateTable() throws ParseException {
		StatementTree cmd = new StatementTree("CreateTable");
	...
	final public StatementTree CreateTrigger() throws ParseException {
		StatementTree cmd = new StatementTree("CreateTrigger");
		boolean callback;
		String trigger_name;
	...
	final public StatementTree DropTrigger() throws ParseException {
		StatementTree cmd = new StatementTree("DropTrigger");
		String trigger_name;
		String type = null;
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case CALLBACK:
	...
	final public StatementTree CreateFunction() throws ParseException {
		StatementTree cmd = new StatementTree("Function");
		...
		cmd.putObject("location_name", SQLUtil.toParamObject(loc_name, false));
	...
	final public StatementTree CreateSchema() throws ParseException {
		StatementTree cmd = new StatementTree("Schema");
		cmd.putObject("type", "create");
		String schema_name;
	...
	final public StatementTree CreateView() throws ParseException {
		StatementTree cmd = new StatementTree("ViewManager");
		String view_name;
	...
	final public StatementTree CreateIndex() throws ParseException {
		StatementTree cmd = new StatementTree("NoOp");
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case UNIQUE:
	...
	final public StatementTree DropTable() throws ParseException {
		StatementTree cmd = new StatementTree("DropTable");
	...
	final public StatementTree Call() throws ParseException {
		StatementTree cmd = new StatementTree("Call");
		String proc_name;
	...
	final public StatementTree CreateSequence() throws ParseException {
		StatementTree cmd = new StatementTree("Sequence");
		cmd.putObject("type", "create");
		String seq_name;
		Expression v;
	...
	final public StatementTree CreateUser() throws ParseException {
		StatementTree cmd = new StatementTree("UserManager");
	...
	final public StatementTree Delete() throws ParseException {
		StatementTree cmd = new StatementTree("Delete");
		String table_name;
		SearchExpression where_clause = new SearchExpression();
		int limit = -1;
	...
	final public StatementTree Insert() throws ParseException {
		StatementTree cmd = new StatementTree("Insert");
		String table_name;
		ArrayList col_list = new ArrayList();
	...
	final public StatementTree Describe() throws ParseException {
		StatementTree cmd = new StatementTree("Show");
	...
	final public StatementTree Grant() throws ParseException {
		StatementTree cmd = new StatementTree("PrivManager");
	...
	final public StatementTree CompleteTransaction() throws ParseException {
		StatementTree cmd = new StatementTree("CompleteTransaction");
		String command;
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case COMMIT:
	...
	final public StatementTree Set() throws ParseException {
		StatementTree cmd = new StatementTree("Set");
		Token t1;
		String value;
		Expression exp;
		String name;
	...
	final public StatementTree ShutDown() throws ParseException {
		StatementTree cmd = new StatementTree("Misc");
	...
	final public String PrivObject() throws ParseException {
		...
		case SLASH_DELIMINATED_REF:
		case QUOTED_DELIMINATED_REF:
		case QUOTED_SLASH_DELIMINATED_REF:
			switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
			case TABLE:
				jj_consume_token(TABLE);
				break;
	...
	final public TableSelectExpression GetTableSelectExpression() throws ParseException {
		...
		case TOP:
			...
			case 237:
				jj_consume_token(237);
				table_expr.top = PositiveIntegerConstant();
				jj_consume_token(238);
				break;
			case NUMBER_LITERAL:
				table_expr.top = PositiveIntegerConstant();
	...
	final public SelectColumn SelectColumn() throws ParseException {
		...
		case QUOTEDGLOBVARIABLE:
			...
			col.glob_name = caseCheck(SQLUtil.asNonQuotedRef(t));
			break;
		default:
			jj_la1[89] = jj_gen;
			jj_consume_token(-1);
	...
	final public int GetCollateStrength() throws ParseException {
		...
		case PRIMARY_STRENGTH:
			...
			{
				if (true)
					return java.text.Collator.PRIMARY;
			}
			break;
		...
		case TERTIARY_STRENGTH:
			...
			{
				if (true)
					return java.text.Collator.TERTIARY;
			}
			break;
		case IDENTICAL_STRENGTH:
			...
			{
				if (true)
					return java.text.Collator.IDENTICAL;
			}
			break;
		default:
			jj_la1[119] = jj_gen;
	...
	final public int GetCollateDecomposition() throws ParseException {
		...
		case NO_DECOMPOSITION:
			...
			{
				if (true)
					return java.text.Collator.NO_DECOMPOSITION;
			}
			break;
		case CANONICAL_DECOMPOSITION:
			...
			{
				if (true)
					return java.text.Collator.CANONICAL_DECOMPOSITION;
			}
			break;
		...
		default:
			...
			if (jj_2_7(2147483647)) {
				...
				case COLLATE:
					...
					loc = ((TObject) SQLUtil.toParamObject(t, false)).toString();
					switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
					case PRIMARY_STRENGTH:
					case SECONDARY_STRENGTH:
					case TERTIARY_STRENGTH:
	...
	final public Expression DoExpression() throws ParseException {
		...
		Expression normalized_exp = SQLUtil.normalize(exp);
		...
		if (jj_2_12(3)) {
			...
			case REGEX:
				...
				case REGEX_LITERAL:
					...
					regex_ob = SQLUtil.toParamObject(t, false);
		...
		default:
			...
			if (jj_2_14(2)) {
				...
				case TIMESTAMP:
					...
					t = jj_consume_token(STRING_LITERAL);
					Object param_ob1 = SQLUtil.toParamObject(t, false);
					exp_list = new Expression[] { new Expression(param_ob1) };
					f = SQLUtil.resolveFunctionName(time_fname, exp_list);
					exp.addElement(f);
					exp.text().append(tt.image).append(" ").append(t.image);
					exp.xttext().append(tt.image).append(" ").append(t.image);
					break;
				case CURRENT_TIME:
				case CURRENT_DATE:
				case CURRENT_TIMESTAMP:
				...
				case STRING_LITERAL:
					...
					param_ob = SQLUtil.toParamObject(t, false);
					exp.addElement(param_ob);
					exp.text().append(t.image);
					exp.xttext().append(t.image);
					break;
				case ADD:
				case SUBTRACT:
				case ROW:
				...
				case QUOTED_DELIMINATED_REF:
					...
					if (t.kind == SQLParserConstants.NUMBER_LITERAL) {
						param_ob = SQLUtil.parseNumberToken(t, negative);
						exp.addElement(param_ob);
					} else {
						param_ob = SQLUtil.toParamObject(t, false);
						if (negative) {
							exp.addElement(SQLUtil.zeroNumber());
							exp.addElement(param_ob);
					...
					exp.text().append(t.image);
					exp.xttext().append(SQLUtil.xtText(t.image));
					break;
				default:
					jj_la1[171] = jj_gen;
					jj_consume_token(-1);
	...
	final public void SubQueryExpression(Expression exp, Stack stack) throws ParseException {
		...
		case SELECT:
			...
			exp.xttext().append(" [SELECT]");
			break;
		default:
			jj_la1[172] = jj_gen;
			exp_arr = ExpressionList();
			exp.addElement(SQLUtil.toArrayParamObject(exp_arr));
			exp.text().append(" (" + SQLUtil.expressionListToString(exp_arr) + ")");
			exp.xttext().append(" (" + SQLUtil.expressionListToString(exp_arr) + ")");
		}
		jj_consume_token(238);
	}
	...
	final public void BetweenPredicate(Expression exp, Stack stack) throws ParseException {
		...
		if (not_s) {
			...
			exp.xttext().append(" between ");
		}
		exp.text().append(exp1.text().toString());
		exp.text().append(" and ");
		exp.text().append(exp2.text().toString());

		exp.xttext().append(exp1.text().toString());
		exp.xttext().append(" and ");
		exp.xttext().append(exp2.text().toString());
	}
	...
	final public FunctionDef Function() throws ParseException {
		...
		case EXISTS:
			...
			exp_list[0] = new Expression();
			SubQueryExpression(exp_list[0], new Stack());
			break;
		case NOTEXISTS:
			t = jj_consume_token(NOTEXISTS);
			exp_list = new Expression[1];
			exp_list[0] = new Expression();
			SubQueryExpression(exp_list[0], new Stack());
			break;
		...
		case TRIM:
			...
			Object str_char = t3 == null ? TObject.stringVal(" ") : SQLUtil.toParamObject(t3, false);
			...
			{
				if (true)
					return SQLUtil.resolveFunctionName("sql_trim", exp_list);
			}
			break;
		case CAST:
			...
			{
				if (true)
					return SQLUtil.resolveFunctionName("sql_cast", exp_list);
			}
			break;
		case IF:
		case USER:
		...
		{
			if (true)
				return SQLUtil.resolveFunctionName(t.image, exp_list);
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public FunctionDef JavaInstantiation() throws ParseException {
		...
		{
			if (true)
				return SQLUtil.resolveFunctionName("_new_JavaObject", comp_args);
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public String TableName() throws ParseException {
		...
		case QUOTED_DELIMINATED_REF:
			...
			break;
		case SLASH_DELIMINATED_REF:
			name = jj_consume_token(SLASH_DELIMINATED_REF);
			break;
		case QUOTED_SLASH_DELIMINATED_REF:
			name = jj_consume_token(QUOTED_SLASH_DELIMINATED_REF);
			break;
		default:
			jj_la1[196] = jj_gen;
			jj_consume_token(-1);
		...
		{
			if (true)
				return caseCheck(SQLUtil.asNonQuotedRef(name));
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public Variable ColumnNameVariable() throws ParseException {
		...
		{
			if (true)
				return (Variable) SQLUtil.toParamObject(name, false);
		}
		throw new Error("Missing return statement in function");
	}
	...
	final private boolean jj_3R_87() {
		if (jj_scan_token(QUOTED_DELIMINATED_REF))
			return true;
		if (jj_la == 0 && jj_scanpos == jj_lastpos)
			return false;
		return false;
	...
	final private boolean jj_3R_86() {
		if (jj_scan_token(DOT_DELIMINATED_REF))
			return true;
		if (jj_la == 0 && jj_scanpos == jj_lastpos)
			return false;
		return false;
	...
	final private boolean jj_3R_85() {
		if (jj_scan_token(QUOTED_VARIABLE))
			return true;
		if (jj_la == 0 && jj_scanpos == jj_lastpos)
			return false;
		return false;
	...
	final private boolean jj_3R_84() {
		if (jj_scan_token(NUMBER_LITERAL))
			return true;
		if (jj_la == 0 && jj_scanpos == jj_lastpos)
			return false;
		return false;
	...
	final private boolean jj_3R_43() {
		if (jj_scan_token(PARAMETER_REF))
			return true;
		if (jj_la == 0 && jj_scanpos == jj_lastpos)
			return false;
		return false;
	...
	final private boolean jj_3R_70() {
		if (jj_scan_token(REGEX_LITERAL))
			return true;
		if (jj_la == 0 && jj_scanpos == jj_lastpos)
			return false;
		return false;
	...
	final private int[] jj_la1_0 = { 0xffc00000, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8000000, 0x8000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
			0x2000000, 0x2000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40000000, 0x0, 0x0, 0x34000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x36000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x400000, 0x0, 0x0, 0x1400000, 0x1b0000, 0x0, 0x1b0000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1b0080, 0x0,
			0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x100000, 0x0, 0x0, 0x100000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
			0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x78080, 0x7ff80, 0x200000, 0x200000, 0x0, 0x0, 0x0, 0x180000, 0x30000, 0x30000, 0x0, 0x0, 0x1b0000, 0x2000000, 0x0, 0x0, 0x0, 0x7f00, 0x0, 0x7f00, 0x0, 0x7f00, 0x38080, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
			0x80, 0x0, 0x1b0000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, };
	final private int[] jj_la1_1 = { 0x1008867a, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80, 0x0, 0x0, 0x0, 0x7800, 0x7800, 0x0, 0x0, 0x0, 0x10000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x800000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x800000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10000000, 0x0, 0x0, 0x0,
			0x0, 0x0, 0x10000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x400000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x0, 0x4000000, 0x4000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4000000, 0x0, 0x0, 0x0, 0x0, 0x10000000, 0x0, 0x0, 0x0, 0x800000, 0x0, 0x800000, 0x0, 0x4000000, 0x0, 0x200000, 0x0,
			0x800000, 0x0, 0x40000000, 0x0, 0x40000000, 0x40000000, 0x80000000, 0x200000, 0x80200000, 0x0, 0x80000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
			0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x400000, 0