...
public class QueryDefintionEditorActivationListener extends XMLPartActivationListener {

	public QueryDefintionEditorActivationListener(XMLFormEditor editor, IPartService partService) {
	...
	public void partOpened(IWorkbenchPart part) {
		...
		if (part == editor) {
			...
			// Expand all items and select the SQL node
				...
				public IStatus runInUIThread(IProgressMonitor monitor) {
					try {
						...
						for (Object item : children) {
							if (item.toString().toLowerCase().contains("sql")) {
